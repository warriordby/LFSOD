...
import math
import sys
sys.path.append('/root/autodl-tmp/LFSOD/bestlf/')
...
class PyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        self.PAM_One = PAM(64,opt.batch_size)
        self.PAM_Two = PAM(128,opt.batch_size)
        self.PAM_Thr = PAM(320,opt.batch_size)
        self.PAM_For = PAM(512,opt.batch_size)
...
if __name__=='__main__':
    ...
    model=pvt_v2_b2()
    outs, ou1, out2, out3, out4=model(x)