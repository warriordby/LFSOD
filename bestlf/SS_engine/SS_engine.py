...
from SS_utils.pyt_utils import load_model, parse_devices, extant_file, link_file, ensure_dir
...
class Engine(object):
    def __init__(self, config=None):
        ...
        if config is None:
            ...
            assert isinstance(config, argparse.ArgumentParser)
            self.parser = config
