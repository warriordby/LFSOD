...
parser.add_argument('--load_mit', type=str, default='/root/autodl-tmp/LFSOD/bestlf/pretain_weight/pvt_v2_b2.pth', help='train from checkpoints')#default=r'.\pretrained_params\pvt_v2_b2.pth'
