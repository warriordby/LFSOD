...
from Builder.MLPDecoder import DecoderHead
...
class model(nn.Module):
    ...
    def forward(self, y):#focal  torch.Size([840, 3, 256, 256]) , image  torch.Size([70, 3, 256, 256])
                    #focal,focal_stack, images
        #focal
        y,out1,out2,out3,out4 = self.focal_encoder(y)  #[64] [128] [320] [512]
