...
def preprocess_tensors(gts, focal, images): #images torch.Size([70, 3, 256, 256])  focal torch.Size([70, 36, 256, 256])
    gts = gts.cuda() 
...
import torch
import logging
from Network_utils.pytorch_utils import Save_Handle
